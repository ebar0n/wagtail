...
class TestStreamBlock(WagtailTestUtils, SimpleTestCase):
    ...
    def test_max_min_fields_min_validation_errors(self):
        class ValidatedBlock(blocks.StreamBlock):
            char = blocks.CharBlock()
            url = blocks.URLBlock()
        block = ValidatedBlock(max_min_fields={'char': {'min_num': 1}})
    ...
    def test_max_min_fields_max_validation_errors(self):
        class ValidatedBlock(blocks.StreamBlock):
            char = blocks.CharBlock()
            url = blocks.URLBlock()
        block = ValidatedBlock(max_min_fields={'char': {'max_num': 1}})
